...
export default class Camera {
    ...
    getPosition() {
        ...
        if (this.currentZoom > 0) {
            vec3.scaleAndAdd(this._cpos, tgt, this._dirVector, -this.currentZoom)
        } else {
            vec3.copy(this._cpos, tgt)
        }
        return this._cpos
    }
    ...
    */
    applyInputsToCamera() {
        ...
        vec3.rotateX(this._dirVector, this._dirVector, this._origin, this.pitch)
        vec3.rotateY(this._dirVector, this._dirVector, this._origin, this.heading)
    }
